...
PASSWORD = "password" 
PASSWORD_VAULT = {aws: {username: "ashley", password: "asdfasdf"}}
...
def retrieve_service_name
    print "Please enter the name of the service you want to access credentials for: "
    gets.chomp
end
